...
def create_bcs(t, DVP, mesh, boundaries, mu_f, dvp_, t_ramp,
               inlet_id, inlet_outlet_s_id,
               rigid_id, psi, F_fluid_nonlinear, p_deg, Q_file, Q_mean, p_wave_file, **namespace):
    ...
    # Two outlet surface has ID 3 and 4
    dso_1 = ds(3, domain=mesh, subdomain_data=boundaries)
    ...
    return dict(bcs=bcs, inlet=inlet, p_out_bc_val=p_out_bc_val, F_fluid_nonlinear=F_fluid_nonlinear)
